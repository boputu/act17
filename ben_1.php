...
<html>
  ...
  //Si falla sale este mensaje de error
    ...
    //Si funciona pasa esto
     ...
     <h1> Beneficios Semana 1</h1> <hr><br>




       <?php
         $gasto1 = $conexion->query("SELECT gasto,num_semana FROM gastos WHERE num_semana='1'");
         $contgasto1=0;
         while ($gastosem1=$gasto1->fetch_assoc()) {

           $contgasto1=$contgasto1+$gastosem1['gasto'];
 ...
 ?>
     <?php
       $venta1 = $conexion->query("SELECT venta,num_semana FROM ventas WHERE num_semana='1'");
       $contventa1=0;
       while ($ventasem1=$venta1->fetch_assoc()) {

         $contventa1=$contventa1+$ventasem1['venta'];
